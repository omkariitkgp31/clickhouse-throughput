...
app.get('/api/v1/assets/:id/location', async (req: Request, res: Response) => {
...
app.get('/api/v1/assets/:id/route', async (req: Request, res: Response) => {
  const assetId = req.params.id;
...
async function getNginxMetrics(): Promise<Record<string, any>> {
...
async function getKafkaMetrics(brokerStr: string, topic: string): Promise<Record<string, any>> {
...
app.get('/api/v1/system/metrics', async (req: Request, res: Response) => {
  try {
